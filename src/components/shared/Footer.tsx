        ...
        <div className="footer-top">
          <div className="footer-column">
            ...
            <p className="footer-description">
              Empowering financial freedom through innovative loan solutions against mutual funds.
          ...
          <div className="footer-column">
            ...
            <ul className="footer-contact">
              <li>
                ...
                <a href="mailto:support@1fi.in">support@1fi.in</a>
              </li>
              <li>
                <span className="contact-icon">📞</span>
        ...
        <div className="footer-bottom">
          <div className="footer-disclaimer">
            <p>
              ...
              All loan products are provided by our NBFC partners.
            </p>
          </div>
          <div className="footer-copyright">
            <p>&copy; {currentYear} 1Fi Technologies Private Limited. All rights reserved.</p>
            <p className="sebi-registration">SEBI Registration No.: INZ000123456</p>
          </div>
        </div>
      </div>
    </footer>
